...
public class VisitRecord extends UpdatableRecordImpl<VisitRecord> implements Record5<Integer, Integer, Integer, Integer, Integer> {

    private static final long serialVersionUID = -1543865938;
     ...
     */
    public void setVisitedAt(Integer value) {
        set(3, value);
    }
     ...
     */
    @Override
    public VisitRecord value4(Integer value) {
        setVisitedAt(value);
        return this;
    }
     ...
     */
    @Override
    public VisitRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public VisitRecord(Integer id, Integer locationId, Integer userId, Integer visitedAt, Integer mark) {
        super(Visit.VISIT);
